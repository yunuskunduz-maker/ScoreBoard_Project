...
/* Private defines -----------------------------------------------------------*/
#define A1_5_LDR_Pin GPIO_PIN_5
#define A1_5_LDR_GPIO_Port GPIOA
#define BUTON1_Pin GPIO_PIN_2
#define BUTON1_GPIO_Port GPIOB
#define BUTON1_EXTI_IRQn EXTI2_3_IRQn
#define BUTON2_Pin GPIO_PIN_10
#define BUTON2_GPIO_Port GPIOB
#define BUTON2_EXTI_IRQn EXTI4_15_IRQn
#define BUTON3_Pin GPIO_PIN_11
